...
export declare const seedDefaultBadges: () => Promise<void>;
...
export declare const awardBadge: (req: AuthRequest, res: Response) => Promise<void>;
...
export declare const toggleBadgeActive: (req: AuthRequest, res: Response) => Promise<void>;
