    ...
    <div className="min-h-screen login-bg flex items-center justify-center p-4">
      <div className="w-full max-w-[480px] bg-white rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="bg-[#3B82F6] text-center pt-8 pb-6 flex flex-col items-center">
          ...
          <h1 className="text-white text-3xl font-medium tracking-tight mb-1">EduQuest</h1>
          <p className="text-blue-100/90 text-xs font-medium">Gamified Learning Platform · Sri Lanka</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mt-8 text-center text-sm font-medium text-slate-500">
            Don't have an account? <Link href="/register" className="text-blue-600 hover:text-blue-700">Create one</Link>
          </div>
        </div>
